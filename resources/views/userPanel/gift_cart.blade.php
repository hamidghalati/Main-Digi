                    ...
                    <thead>
                     ...
                     @foreach($gift_cart as $key=>$value)
                         ...
                         <tr>
                             ...
                             <td>{{$value->code}}</td>
                             <td style="font-family: 'IRANSans';font-size: 13px;">{{replace_number(number_format($value->credit_cart))}} تومان </td>
                             <td style="font-family: 'IRANSans';font-size: 13px;">{{replace_number(number_format($value->credit_used))}} تومان </td>
